...
IF ~True()~ THEN BEGIN Meet
  ...
  IF ~Global("WhatDo","LOCALS",0)
      GlobalLT("Chapter","GLOBAL",%bg2_chapter_8%)~ THEN REPLY @3002 DO ~SetGlobal("WhatDo","LOCALS",1)~ GOTO What
  IF ~Global("WhatDoToB","LOCALS",0)
      GlobalGT("Chapter","GLOBAL",%bg2_chapter_7%)~ THEN REPLY @3010 DO ~SetGlobal("WhatDoToB","LOCALS",1)~ GOTO WhatToB
  IF ~OR(2) Global("WhatDo","LOCALS",1)
            GlobalGT("Chapter","GLOBAL",%bg2_chapter_7%)~ THEN REPLY @3003 GOTO Upgrade
...
IF ~~ THEN BEGIN Upgrade
  ...
  IF ~PartyHasItem("npsw04") GlobalGT("Chapter","GLOBAL",%bg2_chapter_7%)~ THEN REPLY @3218 GOTO Corthala3
  IF ~PartyHasItem("u#sw1h06") GlobalGT("Chapter","GLOBAL",%bg2_chapter_7%)~ THEN REPLY @3219 GOTO Corthala4
  ...
  IF ~PartyHasItem("brac19") GlobalGT("Chapter","GLOBAL",%bg2_chapter_7%)~ THEN REPLY @3241 GOTO MitsShaiman
  ...
  IF ~PartyHasItem("blun35") GlobalGT("Chapter","GLOBAL",%bg2_chapter_7%)~ THEN REPLY @3245 GOTO ColdShoulder
